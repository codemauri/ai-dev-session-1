...
export default function SharedRecipe({ params }: { params: Promise<{ token: string }> }) {
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="bg-red-50 border border-red-200 rounded-lg p-6 max-w-2xl mx-auto">
          ...
          <p className="text-red-600">{error || 'This shared recipe is not available.'}</p>
          <p className="text-sm text-gray-600 mt-2">The recipe may have been made private or deleted.</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
          <p className="text-blue-800 text-sm flex items-center gap-2">
            ...
            This is a publicly shared recipe
          </p>
        </div>
